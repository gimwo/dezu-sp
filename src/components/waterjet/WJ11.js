    ...
    <div className="text-table-wglitch-wj6">
      ...
      <div className="center-container">
        <div>
          ...
          <h3 className="sub-heading orbitron" style={{ color: color.color }}>REMOVAL OF PAINT RESIDUE</h3>
          <h1 className="main-heading rajdhani-medium">PAINT BOOTH CLEANING</h1>
        </div>
