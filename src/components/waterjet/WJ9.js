    ...
    <div className="text-table-wglitch-wj6">
      ...
      <div className="center-container">
        <div>
          ...
          <h1 className="main-heading rajdhani-medium">TANK AND VESSEL CLEANING</h1>
        </div>
